...
pancreas.combined <- readRDS(file = r"(C:\Users\mqadir\Box\Lab 2301\1. R_Coding Scripts\Sex Biology Study\RDS files\pancreas.combined.correctedSCT.rds)")

# 1A.Beta-cells (INS Hi) ####
